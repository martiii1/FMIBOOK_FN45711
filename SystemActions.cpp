...
bool SystemActions::actionCheck(const UserData &actor, SystemActions::Actions action,const UserData &subject)
{
    switch (action)
    {
...
void SystemActions::isTheActionAllowed(const UserData &actor, SystemActions::Actions action,const UserData &subject)
{
